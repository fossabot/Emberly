...
export const metadata = buildPageMetadata({
  title: 'Discord',
  description:
    'Join the Emberly community on Discord for support, announcements, and more.',
})
...
const COMMUNITY_FEATURES = [
  {
    ...
    description:
      'Ask questions and get help from the community and team members.',
    color: 'text-chart-1',
    bg: 'bg-chart-1/10',
  },
  {
...
const CHANNELS = [
  {
    icon: Hash,
    name: 'general',
    description: 'Hang out and chat with the community',
  },
  {
    icon: MessageSquare,
    name: 'support',
    description: 'Get help with your setup or account',
  },
                ...
                <GlassCard className="relative animate-float">
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-5">
                      ...
                      <Badge
                        variant="secondary"
                        className="ml-auto bg-chart-4/10 text-chart-4 border-chart-4/20 text-xs"
                      >
                        Online
                      </Badge>
                    </div>
                    <div className="space-y-2">
                      {CHANNELS.slice(0, 4).map((channel) => (
                        <div
                          key={channel.name}
                          className="flex items-center gap-3 px-3 py-2 rounded-lg glass-subtle"
                        >
          ...
          <GlassCard>
            <div className="p-6 h-full flex flex-col">
              ...
              <p className="text-sm text-muted-foreground flex-1">
                Boost the server and unlock exclusive perks to supercharge your
                Emberly experience.
              </p>
              ...
              <Button
                variant="outline"
                className="mt-6 w-full bg-background/50"
                asChild
              >
                <Link href="/pricing#user-add-ons">Learn More</Link>
              </Button>
            </div>
          </GlassCard>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <GlassCard>
            <div className="p-6 h-full flex flex-col">
              ...
              <p className="text-sm text-muted-foreground flex-1">
                If you have account or billing questions, open a support ticket
                in Discord or email the team. We&apos;re here to help.
              </p>
        ...
        <GlassCard className="gradient-border-animated">
          <div className="p-8 text-center">
            ...
            <p className="mt-3 text-muted-foreground max-w-xl mx-auto">
              Connect with developers, get support, and be part of the Emberly
              community.
            </p>
            <div className="mt-6">
              <Button size="lg" asChild className="group">
