import { ResendVerificationForm } from '@/packages/components/auth/resend-verification-form'
...
export const metadata = buildPageMetadata({
  ...
  description: 'Request a new email verification code for your Emberly account.',
})
