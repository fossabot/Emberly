...
import { createApiKey, listApiKeys } from '@/packages/lib/nexium/squads'
import { z } from 'zod'
...
export async function GET(
  ...
  try {
    ...
    if (err.message === 'Not a squad member')
...
export async function POST(
  ...
  try {
    ...
    if (err.message === 'Squad not found')
      return apiError('Squad not found or access denied', HTTP_STATUS.NOT_FOUND)
