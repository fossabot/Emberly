          ...
          <Container className="mx-auto max-w-2xl px-4 py-8">
            ...
            <Section className="border border-gray-200 rounded-lg bg-white p-8">
              ...
              <Row>
                <Column>
                  ...
                  <Text className="m-0 mb-6 text-base leading-relaxed text-gray-700">
                    Squads let you collaborate with like-minded builders, share
                    opportunities, and grow together as a team.
                  </Text>
                </Column>
              </Row>
              ...
              {[
                {
                  icon: '🤝',
                  desc: 'Build alongside teammates who share your interests',
                },
                {
                  icon: '📣',
                  desc: 'Stay in the loop on squad opportunities and announcements',
                },
                {
                  icon: '🏆',
                  desc: 'Gain squad recognition and boost your Nexium presence',
                },
              ].map((benefit, idx) => (
                <Row key={idx} className="mb-2">
                  ...
                  <Column className="flex-1">
                    <Text className="m-0 text-gray-700">{benefit.desc}</Text>
                  </Column>
                </Row>
              ))}
              ...
              <Row className="mt-6 p-4 rounded-lg bg-yellow-50 border border-yellow-200">
                <Column align="center">
                  <Text className="m-0 text-sm text-yellow-800">
                    <strong>⏰ This invite expires in 7 days</strong> – accept
                    it soon to secure your spot.
                  </Text>
                </Column>
              </Row>
              ...
              <Row className="mt-4">
                <Column className="rounded-lg bg-blue-50 p-4 border border-blue-200">
                  <Text className="m-0 text-sm text-blue-900">
                    <strong>Not expecting this?</strong> If you don't know{' '}
                    {inviterName} or weren't expecting an invite, you can safely
                    ignore this email.
                  </Text>
                </Column>
              </Row>
